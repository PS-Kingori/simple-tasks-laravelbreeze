    ...
    return (
        <div className="min-h-screen ">
            <nav className="">
                ...
                <h3 className='font-bold'>Simple tasks</h3>
                </Link>
                            </div>

                            <div className="hinccuridden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                                <NavLink href={route('dashboard')} active={route().current('dashboard')} className=''>
                                    Dashboard
                                </NavLink>
